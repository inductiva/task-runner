...
class BaseExecuter(ABC):
    ...
    def __init__(
        ...
        self.command_event_logger = command_event_logger
    ...
    def run_subprocess(
        ...
        with open(self.stdout_logs_path, "a", encoding="UTF-8") as stdout, \
            ...
            self.command_event_logger.log_command_started(
                command=" ".join(command_args),
                apptainer_command=" ".join(apptainer_command_args),
            )
            ...
            self.command_event_logger.log_command_finished(
                command=" ".join(command_args),
                exit_code=exit_code,
