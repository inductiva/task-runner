...
DOCKER_HUB_USER=inductiva
DOCKER_TASK_RUNNER_CONTAINER_MAIN=$(DOCKER_HUB_USER)/task-runner:main
DOCKER_FILE_TRACKER_CONTAINER_MAIN=$(DOCKER_HUB_USER)/file-tracker:main
DOCKER_TASK_RUNNER_CONTAINER_MAIN=$(DOCKER_HUB_USER)/task-runner:dev
DOCKER_FILE_TRACKER_CONTAINER_MAIN=$(DOCKER_HUB_USER)/file-tracker:dev
...
task-runner-up:
	TASK_RUNNER_CONTAINER=$(DOCKER_TASK_RUNNER_CONTAINER_MAIN) \
	FILER_TRACKER_CONTAINER=$(DOCKER_FILE_TRACKER_CONTAINER_MAIN) \
